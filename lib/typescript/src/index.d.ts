...
export declare type SafeAreaViewForceInsetValue = 'always' | 'never';
...
export default class SafeAreaView extends React.Component<SafeAreaViewProps, SafeAreaViewState> {
    ...
    _getInset: (key: "left" | "right" | "top" | "bottom" | "horizontal" | "vertical") => never;
}
export {};
